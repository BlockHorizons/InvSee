...
abstract class BaseCommand extends Command implements PluginIdentifiableCommand {
	...
	public static function registerDefaults(Loader $loader): void {
		...
		foreach([
			EnderInvSeeCommand::class => ["enderinvsee", "эндер сундук игрока.", "/enderinvsee <player>", "invsee.enderinventory.view"],
			InvSeeCommand::class => ["invsee", "инвентарь игрока.", "/invsee <player>", "invsee.inventory.view"]
